...
if (!($categorias and $nomeequip and $descricao and $quantidade and $id)) {
    $continuacao = "Location: produtos.php";
...
// Testar a ligação
mysqli_set_charset($conn, "utf8"); // verificar os carateres
if (!$conn) {
...
if ($response["message"] != "") {
    ...
    $sql = "UPDATE equipamentos SET Nome_Equipamento='$nomeequip', Descricao='$descricao', Total='$quantidade', Quantidade=Quantidade+$total2, Imagem='$files' WHERE Cod_Equipamento=$id";
