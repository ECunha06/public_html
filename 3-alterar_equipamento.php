        ...
        <div class="w3-container w3-medium w3-card-4 w3-light-grey">
            ...
            <form class="w3-container w3-light-grey" method="post" enctype="multipart/form-data" action="3-alterar.php">
                <div class="card-body">
                    ...
                    ?>
                    <!--<input type="checkbox" id="categorias_informatica" name="categorias[]" class="w3-check" value="1"<//?php echo in_array('1', $row2) ? 'checked' : '' ?>>
                    <label for="categorias_informatica"> Informática </label>
                    <input type="checkbox" id="categorias_eletronica" name="categorias[]" class="w3-check" value="2" <//?php echo in_array('2', $row2) ? 'checked' : '' ?>>
                    <label for="categorias_eletronica"> Eletrónica </label>
                    <input type="checkbox" id="categorias_mecatronica" name="categorias[]" class="w3-check" value="3" <//?php echo in_array('3', $row2) ? 'checked' : '' ?>>
                    <label for="categorias_mecatronica"> Mecatrónica </label>
                    <input type="checkbox" id="categorias_outros" name="categorias[]" class="w3-check" value="4" <//?php echo in_array('4', $row2) ? 'checked' : '' ?>>
